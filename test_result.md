...
agent_communication:
    ...
    - agent: "main"
      message: "Starting Service Booking Management module implementation. This module will handle IT services, Starlink installations, technical support bookings, and service scheduling - essential for service-based business operations."
    - agent: "testing"
