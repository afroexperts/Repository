...
agent_communication:
    ...
    - agent: "main"
      message: "Starting Reports Module implementation with comprehensive reporting for ALL modules. Requirements: ✅ PDF export functionality, ✅ Excel export functionality, ✅ Direct printing capability, ✅ Reports for Order Management, Inventory, Finance, Service Booking, Products, Clients, POS, and all other modules. This will provide complete business analytics and record-keeping capabilities."
    - agent: "testing"
